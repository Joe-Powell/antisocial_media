...
<nav class="navbar">
    ...
    <?php  if(isset($_SESSION['userId'])) {
        ...
        ?>
            ...
            <li><form class='profileUploadForm' id='profileUploadForm' method='post' action='index.php' enctype='multipart/form-data'  >
        <input type='file' name='profileUpload' id='profileUpload' hidden='hidden' >
        <label for='profileUpload' class='profileUploadLabel' id='profileUploadLabel'  >Profile Picture</label>
        <input type='submit' name='submit_new_pro_pic' id='submit_new_pro_pic' value='Upload Selected Profile Picture'   >
